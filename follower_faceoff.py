...
def grab():
    ...
    return a_count, b_count, a_name, b_name, a_description, b_description, a_country, b_country


def play():
    global score
    a_count, b_count, a_name, b_name, a_description, b_description, a_country, b_country = grab(
    )
...
def compare():
    ...
    while game is True:
        ...
        if a_count > b_count and ans == 'a':  # Compare to the string 'a'
            score += 1
            print("You win!")
            cls()

        elif a_count < b_count and ans == 'a':  # Compare to the string 'a'
            cls()
            print("You lose!")
            print(f"Your Current Score is {score}.")
            game = False
        ...
        elif a_count < b_count and ans == 'b':  # Compare to the string 'b'
            score += 1
            print("You win!")
            cls()
